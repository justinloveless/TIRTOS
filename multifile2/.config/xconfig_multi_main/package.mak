...
override PKGDIR = xconfig_multi_main
...
package/%.xdc.inc package/%_xconfig_multi_main.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_multi_main" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: multi_main.pem4f

-include package/cfg/multi_main_pem4f.mak
-include package/cfg/multi_main_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/multi_main_pem4f.dep
endif
multi_main.pem4f: package/cfg/multi_main_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
multi_main.pem4f package/cfg/multi_main_pem4f.c: .libraries,em4f
endif

package/cfg/multi_main_pem4f.c package/cfg/multi_main_pem4f.h package/cfg/multi_main_pem4f.xdl: override _PROG_NAME := multi_main.xem4f
package/cfg/multi_main_pem4f.c: package/cfg/multi_main_pem4f.cfg
package/cfg/multi_main_pem4f.xdc.inc: package/cfg/multi_main_pem4f.xdl
package/cfg/multi_main_pem4f.xdl package/cfg/multi_main_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/multi_main_pem4f.cfg
	-$(RM) package/cfg/multi_main_pem4f.dep
	-$(RM) package/cfg/multi_main_pem4f.c
	-$(RM) package/cfg/multi_main_pem4f.xdc.inc

clean,em4f::
	-$(RM) multi_main.pem4f
.executables,em4f .executables: multi_main.xem4f

multi_main.xem4f: |multi_main.pem4f

-include package/cfg/multi_main.xem4f.mak
multi_main.xem4f: package/cfg/multi_main_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armlnk -w -q -u _c_int00 -fs $(XDCCFGDIR)$(dir $@).  -q -o $@ package/cfg/multi_main_pem4f.oem4f   package/cfg/multi_main_pem4f.xdl --silicon_version=7M4 --strict_compatibility=on -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
multi_main.xem4f: export C_DIR=
multi_main.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
multi_main.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

multi_main.test test,em4f test: multi_main.xem4f.test

multi_main.xem4f.test:: multi_main.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 multi_main.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.multi_main.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,multi_main.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
multi_main_pem4f.oem4f,copy : package/cfg/multi_main_pem4f.oem4f
multi_main_pem4f.sem4f,copy : package/cfg/multi_main_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_multi_main
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_multi_main.tar.dep
endif
package/rel/xconfig_multi_main/xconfig_multi_main/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_multi_main/xconfig_multi_main/package/package.rel.xml: package/build.cfg
package/rel/xconfig_multi_main/xconfig_multi_main/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_multi_main/xconfig_multi_main/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_multi_main.tar: package/rel/xconfig_multi_main.xdc.inc package/rel/xconfig_multi_main/xconfig_multi_main/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_multi_main.xdc.inc,package/rel/xconfig_multi_main.tar.dep)


release release,xconfig_multi_main: all xconfig_multi_main.tar
clean:: .clean
	-$(RM) xconfig_multi_main.tar
	-$(RM) package/rel/xconfig_multi_main.xdc.inc
	-$(RM) package/rel/xconfig_multi_main.tar.dep
